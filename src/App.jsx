  ...
  const portfolio = [
    {
      ...
      detail:
        "돌곶이 낭만축제는 돌곶이시장 일대에서 진행된 지역 문화 행사로, 막걸리축제·야외영화관·시장장보기·낭만버스킹 등 다양한 프로그램에 맞춰 무대 운영, 관람 동선, 현장 연출, 시스템 운영을 안정적으로 진행한 프로젝트입니다.",
      gallery: [
        "/portfolio-1.jpg",
        "/portfolio-1-2.jpg",
        "/portfolio-1-3.jpg",
    ...
    },
    {
      ...
      detail:
        "제 2회 지석영 건강축제는 서울 중랑구에서 진행된 건강 테마 축제로, 체험부스, 건강 상담, 초음파 체험, 전통 공연, 무대 프로그램, 현장 안내 동선까지 통합 운영한 행사입니다. 참여형 콘텐츠와 안정적인 현장 운영을 중심으로 구성된 프로젝트입니다.",
      gallery: [
        "/portfolio-7.jpg",
        "/portfolio-7-2.jpg",
        "/portfolio-7-3.jpg",
    ...
    },
    {
      ...
      detail:
        "제 1회 어린이 교통안전문화 축제는 어린이들이 교통안전을 쉽고 재미있게 체험할 수 있도록 구성된 참여형 행사로, 체험 부스 운영, 안전 교육 프로그램, 무대 진행, 현장 동선 관리까지 통합적으로 기획·운영된 프로젝트입니다.",
      gallery: [
        "/portfolio-9.jpg",
        "/portfolio-9-2.jpg",
        "/portfolio-9-3.jpg",
    ...
    },
    {
      ...
      detail:
        "제 2회 및 제 3회 주락이 페스티벌은 지역 주민과 방문객이 함께 즐길 수 있도록 기획된 참여형 축제로, 체험 부스, 공연 프로그램, 현장 동선 설계, 운영 인력 배치, 안전 관리까지 전반적인 운영을 통합적으로 수행한 프로젝트입니다.",
      gallery: [
        "/portfolio-10.jpg",
        "/portfolio-10-2.jpg",
        "/portfolio-10-3.jpg",
    ...
    },
    {
      ...
      detail:
        "제 1회 장안 짤짤이 어린이 당근 마켓은 어린이들이 직접 물건을 사고파는 경험을 통해 경제 개념을 자연스럽게 익힐 수 있도록 기획된 참여형 행사입니다. 플리마켓 운영, 체험 프로그램, 현장 동선 설계, 안전 관리, 운영 인력 배치까지 전반적인 행사 운영을 통합적으로 수행한 프로젝트입니다.",
      gallery: [
        "/portfolio-11.jpg",
        "/portfolio-11-2.jpg",
        "/portfolio-11-3.jpg",
    ...
    },
    {
      ...
      detail:
        "1회부터 6회까지 진행된 말콩달콩 플리마켓 축제는 지역 주민과 방문객이 함께 참여하는 지속형 행사로, 셀러 운영, 체험 프로그램, 무대 구성, 현장 동선 설계, 운영 인력 배치 및 안전 관리까지 전반적인 운영을 반복적으로 수행하며 완성도를 높인 프로젝트입니다.",
      gallery: [
        "/portfolio-12.jpg",
        "/portfolio-12-2.jpg",
        "/portfolio-12-3.jpg",
    ...
    },
    {
      ...
      detail:
        "중랑그린 페스티벌은 친환경과 지역 커뮤니티를 주제로 기획된 행사로, 체험형 프로그램, 친환경 부스, 무대 운영, 현장 동선 설계 및 안전 관리까지 전반적인 운영을 통합적으로 수행한 프로젝트입니다.",
      gallery: [
        "/portfolio-13.jpg",
        "/portfolio-13-2.jpg",
        "/portfolio-13-3.jpg",
    ...
    },
    {
      ...
      detail:
        "동부시장 막걸리 축제는 전통시장 활성화를 목적으로 기획된 지역 축제로, 막걸리 시음, 먹거리 부스, 공연 프로그램, 체험 콘텐츠를 결합한 참여형 행사입니다. 현장 동선 설계, 무대 운영, 인력 배치, 안전 관리까지 전반적인 운영을 통합적으로 수행한 프로젝트입니다.",
      gallery: [
        "/portfolio-14.jpg",
        "/portfolio-14-2.jpg",
        "/portfolio-14-3.jpg",
...
${form.message}`
    ...
    try {
      ...
      if (!response.ok) throw new Error("EmailJS 전송 실패")
    ...
    <div className="min-h-screen bg-white text-zinc-900">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-16 sm:px-6 sm:py-20 md:grid-cols-2 md:gap-10 md:py-28">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <a
                href="#contact"
                className="rounded-2xl bg-white px-5 py-3 text-center text-sm font-semibold text-zinc-950 shadow-sm transition hover:-translate-y-0.5"
              >
                프로젝트 문의하기
              </a>
              <a
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {services.map((item) => (
              <div
                key={item.title}
                className="rounded-3xl bg-white p-7 shadow-sm ring-1 ring-zinc-100 transition hover:-translate-y-1 hover:shadow-lg"
              >
      ...
      <section id="portfolio" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div className="mb-10 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <a href="#contact" className="rounded-2xl border px-4 py-2 text-sm font-semibold hover:bg-zinc-50">
            견적 문의
          </a>
        </div>
        ...
        <div ref={portfolioListRef} className="mt-6 flex gap-6 overflow-x-auto pb-3">
          {sortedPortfolio.map((item) => (
            <article
              key={item.id}
              className="min-w-[280px] max-w-[280px] overflow-hidden rounded-3xl border bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg sm:min-w-[320px] sm:max-w-[320px]"
            >
        ...
        <div
          ref={portfolioDetailRef}
          className="mt-12 rounded-[2rem] border bg-zinc-950 p-5 text-white shadow-xl transition-all duration-500 sm:p-6 md:p-8"
        >
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <a href="#contact" className="rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-zinc-950">
              이 프로젝트 문의하기
            </a>
          </div>
      ...
      <section id="rental" className="bg-zinc-950 py-16 text-white sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <a href="#contact" className="rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-zinc-950">
              렌탈 문의하기
            </a>
          </div>
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          ...
          <form onSubmit={handleSubmit} className="rounded-3xl border bg-zinc-50 p-5 shadow-sm sm:p-6">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <input
                ...
                value={form.email}
                onChange={handleChange}
                className="rounded-2xl border bg-white px-4 py-3 outline-none md:col-span-2"
                placeholder="이메일"
              />
              <input
                name="project"
              ...
              <textarea
                ...
                value={form.message}
                onChange={handleChange}
                className="min-h-[160px] rounded-2xl border bg-white px-4 py-3 outline-none md:col-span-2"
                placeholder="행사 일정, 장소, 예산, 필요한 서비스 등을 적어주세요"
              />
            </div>

            <button
              type="submit"
              className="mt-5 w-full rounded-2xl bg-zinc-950 px-5 py-3 text-sm font-semibold text-white transition hover:opacity-90"
            >
              이메일로 문의하기
            </button>
          </form>
